...
export const teamMembers: TeamMember[] = [
  ...
  {
    id: '2',
    name: 'Dr. Antonio Dionysio Carvalho Paixão',
    role: {
      pt: 'Advogado',
      en: 'Lawyer',
    },
    bio: {
      pt: 'Advogado (OAB/PA e OAB/AM). Especialista em Direito Tributário e Processos Estratégicos. Procurador do Município de Manaus (aposentado).',
      en: "Lawyer (OAB/PA and OAB/AM). Specialist in Tax Law and Strategic Processes. Former Municipal Attorney of Manaus (retired).",
    },
  ...
  },
  {
    ...
    image: 'https://duraesbarros.com.br/wp-content/uploads/2024/04/hellenexemplo.jpg',
    linkedin: 'https://www.linkedin.com/in/rafaelvpaixao/',
    instagram: 'https://www.instagram.com/rafaelvpaixao',
    facebook: 'https://www.facebook.com/rafael.paixao',
    x: 'https://x.com/rafaelvpaixao_',
